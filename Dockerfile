...
# copy feesafe project over to docker image
COPY . /home/ubuntu/feesafe
# make sure we don't read properties from the host environment
RUN rm -f /home/ubuntu/feesafe/local.properties
# make sure we use unix EOL files
RUN find /home/ubuntu/feesafe -type f -print0 | xargs -0 dos2unix --
# make gradle wrapper executable
RUN chmod +x /home/ubuntu/feesafe/gradlew
