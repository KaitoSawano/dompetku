			...
			Label {
				HStack(alignment: VerticalAlignment.center, spacing: 0) {
					VStack(alignment: HorizontalAlignment.leading, spacing: 10) {
						...
						Text(
							"""
							If you do not back it up and you lose access to FeeSafe \
			...
			VStack(alignment: .leading, spacing: 35) {
				...
				Text(
					...
					**Do not share this seed with anyone.** \
					Beware of phishing. The developers of FeeSafe will never ask for your seed.
					"""
				)
		...
		VStack(alignment: HorizontalAlignment.leading, spacing: 0) {
			...
			Label {
				VStack(alignment: HorizontalAlignment.leading, spacing: 10) {
					...
					Text(
						"""
						FeeSafe can restore your funds automatically.
						"""
					)
