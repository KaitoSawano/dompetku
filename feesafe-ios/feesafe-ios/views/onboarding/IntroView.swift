...
struct IntroView1: View, ViewName {
	...
	var body: some View {
		...
		VStack(alignment: HorizontalAlignment.center, spacing: 0) {
			...
			Text("With FeeSafe, sending and receiving bitcoins is easy and safe.")
				.multilineTextAlignment(.center)
				.padding(.vertical, 30)
...
struct IntroView2: View, ViewName {
	...
	var body: some View {
		...
		VStack(alignment: HorizontalAlignment.center, spacing: 0) {
			...
			Text("FeeSafe uses payment channels to make Bitcoin fast and private.")
				.multilineTextAlignment(.center)
				.padding(.vertical, 30)
...
struct IntroView3: View, ViewName {
	...
	var body: some View {
		...
		VStack(alignment: HorizontalAlignment.center, spacing: 0) {
			...
			Text("FeeSafe is self-custodial. You take control.")
				.multilineTextAlignment(.center)
				.padding(.top, 30)
				.padding(.bottom, 15)
