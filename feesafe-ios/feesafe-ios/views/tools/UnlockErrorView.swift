...
fileprivate struct _UnlockErrorView: View {
	...
	var mainContent: some View {
		...
		VStack(alignment: HorizontalAlignment.center, spacing: 0) {
			...
			Text("A temporary error occurred, and FeeSafe is unable to continue loading.")
				.font(.title2)
				.multilineTextAlignment(.center)
				.padding(.bottom, 60)
			
			Text("Please restart FeeSafe")
				.padding(.bottom)
			...
			Text("If the problem persists, please contact support at **feesafe@acinq.co**.")
				.multilineTextAlignment(.center)
				.padding(.bottom)
			...
			Text("FeeSafe Version: \(versionString())")
