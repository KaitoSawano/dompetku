...
//		
//		var body = "FeeSafe v\(appVersion ?? "x.y.z") "
//		body += "(\(device.systemName) \(device.systemVersion))"
//		
//		var comps = URLComponents()
//		comps.scheme = "mailto"
//		comps.path = "feesafe@acinq.co"
//		comps.queryItems = [
//			URLQueryItem(name: "subject", value: "FeeSafe iOS Feedback"),
...
//	}
	...
	func supportButtonTapped() {
		...
		if let url = URL(string: "https://feesafe.acinq.co/support") {
			openURL(url)
		}
	}
	...
	func faqButtonTapped() {
		...
		if let url = URL(string: "https://feesafe.acinq.co/faq") {
			openURL(url)
		}
	}
	...
	func githubButtonTapped() {
		...
		if let url = URL(string: "https://github.com/ACINQ/feesafe") {
			openURL(url)
		}
	}
}
