...
fileprivate let taskId_watchTower = "co.acinq.feesafe.WatchTower"
...
class WatchTower {
	...
	private func performTask(_ task: BGAppRefreshTask, _ target: WatchTowerTarget) {
		...
		let business = FeeSafeBusiness(feesafeGlobal: BusinessManager.feesafeGlobal)
	...
	private func performTask(_ task: BGAppRefreshTask, _ business: FeeSafeBusiness, _ id: String) {
		log.trace(#function)
