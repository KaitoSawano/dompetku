...
struct LiquidityPolicy: Equatable, Codable, CustomStringConvertible {
	...
	static func defaultPolicy() -> LiquidityPolicy {
		return LiquidityPolicy(
			enabled: true,
			maxFeeSats: nil,          // use default value defined in feesafe-shared
			maxFeeBasisPoints: nil,   // use default value defined in feesafe-shared
			skipAbsoluteFeeCheck: nil // use default value defined in feesafe-shared
		)
	}
